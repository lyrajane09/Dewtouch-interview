...
<?php $options_new = array(
 		'Type1' => __('<span class="showDialog" data-id="dialog_1" style="color:blue">Type1</span><div id="dialog_1" class="hide tooltip" title="Type 1">
 				<span style="display:inline-block"><ul><li>Description .......</li>
 				<li>Description 2</li></ul></span>
 				</div>'),
		'Type2' => __('<span class="showDialog" data-id="dialog_2" style="color:blue">Type2</span><div id="dialog_2" class="hide tooltip" title="Type 2">
...
$(document).ready(function(){
	...
	$(".showDialog").on('mouseenter', function(){
		$('#'+$(this).attr('data-id')).fadeIn();
	});

	$(".showDialog").on('mouseleave', function(){
